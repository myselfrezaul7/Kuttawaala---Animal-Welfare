          ...
          <div className="space-y-6 text-slate-800 dark:text-slate-200">
            ...
            <div>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1 text-sm bg-white/20 dark:bg-black/20 p-3 rounded-md">
                <li><span className="font-semibold">kuttawaala_cookie_consent:</span> {t('modals.cookieInfo.necessary.cookie1')}</li>
              </ul>
            </div>
            
            <div>
              <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-2">{t('modals.cookieInfo.functional.title')}</h3>
              <p>{t('modals.cookieInfo.functional.description')}</p>
               <ul className="list-disc list-inside mt-2 space-y-1 text-sm bg-white/20 dark:bg-black/20 p-3 rounded-md">
                <li><span className="font-semibold">kuttawaala_theme:</span> {t('modals.cookieInfo.functional.cookie1')}</li>
                <li><span className="font-semibold">kuttawaala_language:</span> {t('modals.cookieInfo.functional.cookie2')}</li>
                <li><span className="font-semibold">kuttawaala_favorites:</span> {t('modals.cookieInfo.functional.cookie3')}</li>
                <li><span className="font-semibold">kuttawaala_ai_chat_history:</span> {t('modals.cookieInfo.functional.cookie4')}</li>
                <li><span className="font-semibold">kuttawaala_posts:</span> {t('modals.cookieInfo.functional.cookie5')}</li>
                <li><span className="font-semibold">kuttawaala_memorials:</span> {t('modals.cookieInfo.functional.cookie6')}</li>
              </ul>
            </div>
