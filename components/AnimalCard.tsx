...
const AnimalCard: React.FC<AnimalCardProps> = ({ animal, index = 0 }) => {
  ...
  return (
    <div 
      className="bg-white/40 dark:bg-black/40 backdrop-blur-xl border border-white/30 dark:border-white/10 rounded-3xl shadow-lg hover:shadow-2xl overflow-hidden transform hover:-translate-y-2 transition-all duration-500 ease-out flex flex-col group h-full relative will-change-transform"
