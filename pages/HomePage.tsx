      ...
      <div className="w-full">
          ...
          <div className="relative text-center z-10 p-4">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                ...
                className="bg-white text-orange-500 font-bold py-3 px-10 rounded-full text-lg hover:bg-slate-100 transition-all transform hover:scale-105 duration-300 shadow-lg"
              >
                Visit Our Shop
              </a>
            </div>
        ...
        <section className="py-20 bg-slate-100 dark:bg-slate-800">
          <div className="container mx-auto px-6">
              <h2 className="text-4xl font-bold text-slate-800 dark:text-slate-100 mb-4 text-center">Meet Some Friends</h2>
        ...
        <section className="py-20 bg-white dark:bg-slate-900">
          <div className="container mx-auto px-6">
            <h2 className="text-4xl font-bold text-slate-800 dark:text-slate-100 mb-4 text-center">Happy Tails</h2>
            <p className="text-lg text-center text-slate-600 dark:text-slate-300 max-w-3xl mx-auto mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {MOCK_SUCCESS_STORIES.map(story => (
                <div key={story.id} className="bg-slate-50 dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden flex flex-col">
                  <img src={story.imageUrl} alt={story.name} className="w-full h-64 object-cover" />
                  <div className="p-6 flex flex-col flex-grow">
                    <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-100">{story.name}</h3>
                    <blockquote className="mt-4 border-l-4 border-orange-400 pl-4 italic text-slate-700 dark:text-slate-300 flex-grow">
                      <p>{story.story}</p>
                    </blockquote>
                  </div>
                </div>
