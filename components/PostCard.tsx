  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden">
      ...
      <div className="px-6 py-3 border-t border-slate-100 dark:border-slate-700 flex justify-around">
        <button className="flex items-center space-x-2 text-gray-600 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-400 font-semibold transition-colors rounded-lg px-4 py-2 hover:bg-orange-50 dark:hover:bg-slate-700">
