...
const VetClinicCard: React.FC<VetClinicCardProps> = ({ clinic }) => {
  return (
    <div className="bg-white/40 dark:bg-black/40 backdrop-blur-xl border border-white/30 dark:border-white/10 rounded-3xl shadow-lg flex flex-col p-6 sm:p-8 transition-all duration-300 ease-out hover:shadow-2xl hover:bg-white/50 dark:hover:bg-white/5 hover:-translate-y-1 group h-full">
